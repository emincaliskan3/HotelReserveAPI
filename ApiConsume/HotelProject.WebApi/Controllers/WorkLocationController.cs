...
namespace HotelProject.WebApi.Controllers
{
    ...
    public class WorkLocationController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult AddWorkLocation(WorkLocation workLocationService)
        {
            _workLocationService.TInsert(workLocationService);
            return Ok();
        }
        [HttpDelete("{id}")]
        ...
        [HttpPut]
        public IActionResult UpdateWorkLocation(WorkLocation workLocationService)
        {
            _workLocationService.TUpdate(workLocationService);
            return Ok();
        }
        [HttpGet("{id}")]
